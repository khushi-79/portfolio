...
const Project_prop = (props) => {
  return (
    <>
      <div className=" border-[#00040f] shadow-xl  bg-[#e1e1e1] dark:bg-transparent dark:border-white border rounded-xl h-[280px] max-sm:h-[350px] p-7  max-sm:p-3  hover:bg-gradient-to-tl from-[#ccc] to-[#e1e1e1] dark:from-[#00040F] dark:to-[#0B274C]">
        <div className="HEADER">
          <div className="HEADING flex gap-7 max-sm:gap-0">
            ...
            <div className="p-3">
              ...
              <br></br>
              <a href={props.link} className="flex items-center gap-1 text-blue-600 dark:text-cyan-500 hover:underline">
                <SiGithub />
                <span>GitHub</span>
              </a>
            </div>
